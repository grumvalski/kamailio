...
typedef pcontact_t* (*regapi_get_contactp_f)(sip_msg_t *msg, udomain_t* domain, enum pcontact_reg_states reg_state);
 ...
 */
typedef struct p_registrar_api {
	regapi_get_contactp_f get_contactp;
} p_registrar_api_t;

typedef int (*bind_registrar_f)(p_registrar_api_t* api);
int bind_registrar(p_registrar_api_t* api);

/**
 * @brief Load the REGISTRAR API
 */
static inline int registrar_load_api(p_registrar_api_t *api)
{
